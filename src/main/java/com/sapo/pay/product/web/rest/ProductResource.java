package com.sapo.pay.product.web.rest;

import com.sapo.pay.product.domain.Product;
import com.sapo.pay.product.repository.ProductRepository;
import com.sapo.pay.product.service.ProductService;
import com.sapo.pay.product.web.rest.errors.BadRequestAlertException;
import java.net.URI;
...
/**
 * REST controller for managing {@link com.sapo.pay.product.domain.Product}.
 */
@RestController
@RequestMapping("/api")
